...
export default function Dashboard() {
  ...
  const handleStartPractice = (topic) => {
    ...
    if (nid) {
      ...
      // Fallback if no noteId (shouldn't happen with the current API)
                ...
                >
                  <CardContent sx={{ p: "24px !important" }}>
                    ...
                    <ResponsiveContainer width="100%" height={240}>
                      <AreaChart
                        data={data.weekly_activity?.length > 0 ? data.weekly_activity : [
                ...
                >
                  <CardContent sx={{ p: "24px !important" }}>
                    ...
                    <ResponsiveContainer width="100%" height={200}>
                      <BarChart
                        data={data.quiz_scores?.length > 0 ? data.quiz_scores : [
                          { week: "W1", score: 65 },
                          { week: "W2", score: 72 },
                          { week: "W3", score: 68 },
                          { week: "W4", score: 80 },
                ...
                >
                  ...
                  >
                    ...
                    <ResponsiveContainer width="100%" height={200}>
                      <PieChart>
                        <Pie
                          data={data.score_distribution?.length > 0 ? data.score_distribution : [
                            { name: "Excellent (>90%)", value: 2 },
                            { name: "Good (70-90%)", value: 3 },
                            { name: "Average (50-70%)", value: 2 },
                  ...
                  <CardContent sx={{ p: "24px !important" }}>
                    ...
                    <ResponsiveContainer width="100%" height={200}>
                      <RadarChart
                        ...
                        cy="50%"
                        outerRadius="70%"
                        data={data.skill_radar?.length > 0 ? data.skill_radar : [
