...
import { BookOpen, Sparkles, Loader2, ChevronDown, ChevronUp, Lightbulb, BookMarked, GitMerge, Zap, AlertTriangle } from 'lucide-react';
            ...
            <div>
              ...
              <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
                {summary.key_concepts.map((concept, idx) => {
                  const dot = importanceDot[concept.importance] || importanceDot.medium;
                  return (
