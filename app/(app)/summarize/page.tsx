...
export default function SummarizePage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await api.post<SummarizeResponse>(`lectures/${selectedLecture}/summarize/`);
      setSummary(res.summary);
    } catch (err) {
      setError((err as ApiClientError).message || "Failed to generate summary. Please try again.");
